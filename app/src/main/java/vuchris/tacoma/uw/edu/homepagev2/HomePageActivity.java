package vuchris.tacoma.uw.edu.homepagev2;
...
public class HomePageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    {
        startActivity(new Intent("vuchris.tacoma.uw.edu.homepagev2.InstructionsActivity"));
    }

    private void startButtonClick()
    {
        startActivity(new Intent("vuchris.tacoma.uw.edu.homepagev2.DifficultyLevelActivity"));
    }
